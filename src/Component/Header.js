...
// first div: swiggy ka logo and some buttons
...
export default function Header(){
    ...
    return(
        ...
        <header className="bg-[#ff5200] font-serif">
            {/* iss dive ko flex banaya taki jo 4 other anchor tag hai vo line mein aa sake */}
            ...
            <div className="pt-16 pb-8 relative"> 
                ...
                <div className="max-w-[68%] container mx-auto flex gap-5 mt-10">
                  ...
                  <input className="bg-white w-[55%] text-xl px-6 py-4 rounded-2xl" placeholder="Search for restaurant, items or more"></input>
                </div>
            </div>

            <div className="max-w-[80%] container mx-auto flex">

              {/* // here i have used the routing */}
              <Link to="/restaurant">
